...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    driver.manage().window().setSize(new Dimension(736, 578));
  ...
  public void tEST3CATALOG() {
    ...
    driver.manage().window().setSize(new Dimension(736, 578));
    // vars.put("img", js.executeScript("return [getAttribute(\"xpath=//img[@alt=\'Old Deuteronomy\']@src\")]"));
    vars.put("img",driver.findElement(By.xpath("//img[@alt=\'Old Deuteronomy\']")).getAttribute("src"));
